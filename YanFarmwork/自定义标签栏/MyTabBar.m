...
-(instancetype)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        //设置按下时背景图片
        [addBtn setBackgroundImage:[UIImage imageNamed:@"AddButtonIcon-Active"] forState:UIControlStateSelected];
        //添加响应事件
...
-(void)layoutSubviews
{
    ...
    //创建并设置“+”按钮下方的文本为“添加”
    UILabel *addLbl = [[UILabel alloc] init]; //WithFrame:CGRectMake((buttonWidth-40)/2, self.addButton.centerY+self.addButton.height, 40, 15)];
    addLbl.text = @"添加";
