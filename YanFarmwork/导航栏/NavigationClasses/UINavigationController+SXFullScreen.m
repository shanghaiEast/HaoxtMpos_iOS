...
-(void)sx_viewDidLoad {
    ...
    UIScreenEdgePanGestureRecognizer * fullScreenGesture = [[UIScreenEdgePanGestureRecognizer alloc]initWithTarget:internalTarget action:handler];
    fullScreenGesture.edges = UIRectEdgeLeft;
